function [correctlyClassified, classificationErrors] = validateBlockOfTesting(activationFunction, hiddenWeights, outputWeights, inputValues, labels)
...
% 
    ...
    testSetSize = size(inputValues, 2)/20;
    classificationErrors = 0;
    correctlyClassified = 0;
    
    for n = 1: testSetSize
        nn=randi(testSetSize);
        inputVector = inputValues(:, nn);
